...
namespace WLD
{
    Ref<UniformBuffer> UniformBuffer::Create(uint32_t size, uint32_t binding)
    {
        ...
        case RendererAPI::API::OpenGL:  return CreateMemory(OpenGLUniformBuffer, size, binding);
        case RendererAPI::API::Vulkan:  return CreateMemory(VkUniformBuffer, size, binding);
